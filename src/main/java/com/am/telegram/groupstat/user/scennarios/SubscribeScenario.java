...
public class SubscribeScenario implements Scenario {
    ...
    public SubscribeScenario(Assistant assistant, TelegramBot bot, AssistantService assistantService) {
    ...
    public void execute(long chatId) {
        if (assistant.isAdmin() || assistant.hasReadAccess()) {
            ...
            bot.execute(new SendMessage(chatId, "You are subscribed now to a monthly report of group dynamics")
