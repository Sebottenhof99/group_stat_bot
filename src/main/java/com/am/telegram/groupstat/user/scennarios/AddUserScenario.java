...
public class AddUserScenario implements Scenario {
    ...
    public AddUserScenario(Assistant assistant, TelegramBot telegram, AssistantService assistantService) {
    ...
    public void execute(long chatId) {
        ...
        if (assistant.lastGivenAnswer() == null || assistant.lastGivenAnswer().isEmpty()) {
            ...
            bot.execute(new SendMessage(chatId, "User with nickname " + assistant.lastGivenAnswer() + " has been added")
